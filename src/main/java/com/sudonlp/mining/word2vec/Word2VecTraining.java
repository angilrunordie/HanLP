...
class Word2VecTraining
{
    ...
    public void trainModel() throws IOException
    {
        ...
        System.err.println();
        Predefine.logger.info(String.format("finished training in %s", Utility.humanTime(System.currentTimeMillis() - timeStart)));
        // lose weight
        syn1 = null;
        table = null;
        ...
        try
        {
            ...
            Predefine.logger.info("now saving the word vectors to the file " + config.getOutputFile());
