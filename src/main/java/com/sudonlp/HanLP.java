...
public class HanLP
{
    ...
    public static final class Config
    {
        ...
        public static String FoodNameDicPath = "data/dictionary/medicine/foodNames.txt"; // 食物名的字典路径
        public static String DrugNameDicPath = "data/dictionary/medicine/drugNames.txt"; // 药品名的字典路径
