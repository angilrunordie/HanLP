...
public class OrganizationDictionary
{
    ...
    static
    {
        ...
        if (dictionary.load(SudoNLP.Config.OrganizationDictionaryPath))
            logger.info(SudoNLP.Config.OrganizationDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
        else
            throw new IllegalArgumentException(SudoNLP.Config.OrganizationDictionaryPath + "加载失败");
        transformMatrixDictionary = new TransformMatrixDictionary<NT>(NT.class);
        transformMatrixDictionary.load(SudoNLP.Config.OrganizationDictionaryTrPath);
