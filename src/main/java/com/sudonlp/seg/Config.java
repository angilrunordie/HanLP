...
public class Config
{
    public boolean medicineNeRecognize = true;   // 是否对医疗领域的实体进行识别
    public boolean drugNameRecognize = true;     // 是否对药品名称进行识别
    public boolean foodNameRecognize = true;     // 是否对食物名称进行识别
