...
import com.sudonlp.dictionary.medicine.SymptomNameDic;
import com.sudonlp.seg.common.Vertex;
import com.sudonlp.seg.common.WordNet;

import java.util.List;

public class MedicineSymptomNameRecognition {
    public static void recognition(List<Vertex> pWordSegResult, WordNet wordNetOptimum, WordNet wordNetAll) {
        ...
        DoubleArrayTrie<CoreDictionary.Attribute>.Searcher searcher = SymptomNameDic.wordDic.getSearcher(String.valueOf(wordNetAll.charArray), 0);
        while(searcher.next()){
